...
#define MAXTRAFFIC_SMALLCELL OC192	//-B: max amount of overall traffic generated by a single SMALL cell
#define MAXTRAFFIC_MACROCELL OC486	//-B: max amount of overall traffic generated by a single MACRO cell
