...
#define FH_BWD_FX OC120			//-L: BW required for a FH connection at split 7
#define BWDGRANULARITY OC20			//-B: bandwidth granularity -> amount of bandwidth requested by each mobile connection
